...
window.addEventListener("keypress", (key) => {
  ...
  //  alert(key.keyCode);
  if(key.keyCode >= 48 && key.keyCode <= 57 ) /*0 to 9 */
  document.getElementById(String.fromCharCode(key.keyCode) + "-btn").click();
  else if(key.keyCode == 42 || key.keyCode == 43 || key.keyCode == 45 || key.keyCode == 47) /* (*) (+) (-) (/)  */
  document.getElementById(key.keyCode + "-btn").click();
